...
date: 04/25/2026
draft: false
output-file: 260425_97d326.html
---
<!-- 소유권자: 최규빈 | 사용자: 최규빈 -->
...
![](attachments/260425_97d326_01.png)
...
![](attachments/260425_97d326_02.png)

위 그림에서 사기 9건은 두 클러스터 + 한 외톨이 + 한 소액 ($20) 으로 보인다. 다음 그림은 4종 점수의 시간추이.

![](attachments/260425_97d326_03.png)
...
![](attachments/260425_97d326_04.gif)

비교 — $\tau=0$ (snow distance = 신호 L2 거리) 와 $\tau=20000$:

| $\tau=0$ | $\tau=20000$ |
|---|---|
| ![](attachments/260425_97d326_05.png) | ![](attachments/260425_97d326_06.png) |
