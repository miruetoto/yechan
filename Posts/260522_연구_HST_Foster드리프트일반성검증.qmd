...
11개 그래프 — 소미 자체 4개 (kite, $C_{60}$+pendant, $C_{20}$, $K_{10}$) + 24예제 중 대표 7개 (Star Outward, Wheel Bidir, Helm Bidir, D-Helm Bidir, Bidir Path, Bidir Ring, Cyl Inter-bidir) — 의 $M(S_{t_r}) := \max_v |\hbar(v, t_r)|$ 의 round-index 시계열이다. 여기서 $\hbar(v, t) := h(v, t) - \bar h(t)$ 는 centered height, $t_r$ 는 round $r$ 의 block-flag time. Full HST ($b=0.05$, $T_{\max}=20$, $\tau=10^6$, seed=42) 시뮬에서 각 round 시작 시점마다 $M_r$ 한 sample 을 기록.

| 그래프 | $M$ tail mean | $M$ max |
|---|---|---|
| $K_{10}$ complete | $0.10$ | $0.45$ |
| $C_{20}$ cycle | $0.27$ | $0.77$ |
| Cyl Inter-bidir | $0.32$ | $1.03$ |
| Wheel Bidir | $0.43$ | $2.20$ |
| Bidir Ring | $0.56$ | $1.15$ |
| Bidir Path | $20.5$ | $26.3$ |
| D-Helm Bidir | $27.0$ | $34.4$ |
| $C_{60}$+pendant | $61.1$ | $81.4$ |
| Helm Bidir | $291$ | $386$ |
| kite | $1106$ | $1478$ |
| Star Outward | $5292$ | $7061$ |
