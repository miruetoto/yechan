...
각 예제에 대해 3×3 패널 (9가지 시각화):

- **1행 (그래프)**: 원본 그래프 / $W$ 히트맵 / Laplacian eigenvalue 스펙트럼
- **2행 (거리·비대칭)**: $D$ (SP) 히트맵 / $D - D^\top$ 히트맵 / Symmetry scatter
- **3행 (임베딩)**: MDS 2D / Spectral embedding / Sammon dual MDS
