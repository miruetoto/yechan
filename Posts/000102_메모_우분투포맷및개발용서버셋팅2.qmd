...
![](attachments/000102_메모_우분투포맷및개발용서버셋팅2_01.png)

### step2

![](attachments/000102_메모_우분투포맷및개발용서버셋팅2_02.png)

### step3

![](attachments/000102_메모_우분투포맷및개발용서버셋팅2_03.png)
:::
...
![](attachments/000102_메모_우분투포맷및개발용서버셋팅2_04.png)
...
![](attachments/000102_메모_우분투포맷및개발용서버셋팅2_05.png)

`-` 실행파일은 bin 폴더에 있다. 

![](attachments/000102_메모_우분투포맷및개발용서버셋팅2_06.png)

`(base)` 환경이지만 이곳의 실행파일에 직접 접근하여 실행할 수도 있다. 

![](attachments/000102_메모_우분투포맷및개발용서버셋팅2_07.png)

`-` 설치한 패키지는 library 폴더에 있다. /// `EPT`도 보인다..

![](attachments/000102_메모_우분투포맷및개발용서버셋팅2_08.png)
