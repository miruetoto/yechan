...
date: 05/23/2026
draft: false
output-file: 260523_db4951.html
fontsize: 1.0em
execute:
  enabled: false
---
...
![](attachments/260523_db4951_01.png)
...
![](attachments/260523_db4951_02.png)
...
```
A_n (마지막 5개) -- σ_k = k^{-0.6}:
[4.4978 4.4979 4.4981 4.4982 4.4983]

fair walk A_n (마지막 5개): [1996 1997 1998 1999 2000]
```
...
![](attachments/260523_db4951_03.png)
...
```
f(t) = t             : partial sum (n=2000) = 1.64443  (theory π²/6 = 1.64493)
f(t) = sqrt(t(logt)²): partial sum (n=2000) = 1.75645
f(t) = sqrt(t logt)  : partial sum (n=2000) = 3.16100  (diverges)
```
...
![](attachments/260523_db4951_04.png)
...
![](attachments/260523_db4951_05.png)
...
![](attachments/260523_db4951_06.png)
