...
- HST 는 시선 2 를 가장 또렷이 그려냄. 시간이 지날수록 빨강·주황이 한 점으로 모이고, 회색점들이 그 옆에 다닥다닥 붙고, 보라가 살짝 떨어진 자리에 놓임. 회색점 자리까지 맞추는 건 셋 중 HST 뿐임. 저항거리가 이 예제에 가장 어울리는 거리임에도 불구하고 HST 가 회색점의 위치까지 더 단단히 잡아낸다는 게 의미가 큼 — 병렬 path 의 효과는 저항거리가 정의상 가장 잘 다루는 영역인데, 그 영역에서도 HST 가 한 발 더 나아가서 자유도까지 결정해줬다는 뜻. 재미있음.
