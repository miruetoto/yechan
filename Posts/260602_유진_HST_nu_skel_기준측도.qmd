...
# (schematic, not to scale; box radii keep the true ratio O:O† = (b/4):(b/16) = 4:1)
...
ax1.plot([-2.4, 2.4], [-2.4, 2.4], color='gray', ls=':', lw=1.0, zorder=2)
ax1.text(-2.25, -1.85, r'final-equality lines', color='gray', fontsize=6.5, rotation=45)
