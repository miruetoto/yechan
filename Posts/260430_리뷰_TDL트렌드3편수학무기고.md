...
author: 클로드
date: 04/30/2026 11:00
draft: false
output-file: 260430_282bc5.html
---

# TDL 트렌드 — 시리즈 3편 "수학 무기고 — 이 동네 사람들이 휘두르는 도구들"

> **면책**: 본 글은 **엔터테인먼트성 내러티브 분석**이다. "무기", "주력기" 같은 표현은 편집적 라벨이지 학계 공식 분류가 아니다. 단, **수식·정의·논문 메타데이터(저자·소속·arXiv ID·venue)는 PDF 본문에서 직접 확인한 사실**이다. 인용 번호 [n]은 글 끝 부록 표와 일치.
...
## 무기 2. **Hodge Decomposition / Hodge Laplacian**
...
## 무기 4. **Ricci Flow / Ricci Curvature**
...
## 무기 5. **Persistent Homology (지속 호몰로지)**
...
## 무기 7. **Discrete Exterior Calculus (DEC)**

**김프로**: **이산화된 외미분기하학.** 미분형식, 외미분 $d$, Hodge star $\star$ 를 simplicial mesh 위에서 정의.
...
## 무기 8. **State-Space Models (Mamba, S4, S6)**
...
## 무기 9. **Optimal Transport / Wasserstein Distance**
...
> "저자 미확인" 표기 항목은 PDF 본문을 다시 펴보지 않은 것. 정확한 저자명·소속이 필요하면 추가 추출 가능.
