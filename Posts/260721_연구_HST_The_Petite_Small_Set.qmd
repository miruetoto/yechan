...
floor를 위해 우리는 다음의 유리한 (비현실적인) 시나리오로 전이를 아래에서 막는다. 그 다섯 항목은 window의 두 무작위성 원천을 고정하고 결과를 읽어낸다: 항목 (1)–(2)는 적재량을, 항목 (3)–(4)는 낙하들 사이에서 walker가 따라가는 경로(falls가 자유롭게 남긴 이산 선택들)를, 항목 (5)는 높이차가 어디에 놓이는지를 규정한다.
