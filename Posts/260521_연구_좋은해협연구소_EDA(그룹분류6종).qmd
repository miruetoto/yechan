...
date: 05/21/2026
draft: false
output-file: 260521_aee977.html
fontsize: 1.0em
---
...
![① 시기 × 선박 종류 — 1089 → 85 로 트랙이 1/12 수준으로 폭락. tanker:cargo 비율은 두 시기 모두 비슷](attachments/260521_aee977_01.png){fig-align="center"}
...
![② 직진도 분포. 0=극도로 굽거나 회귀, 1=완전 직진. 왼쪽 dashed line < 0.3 = U-turn 후보.](attachments/260521_aee977_02.png){fig-align="center"}
...
![③ 트랙 평균 위도 분포 + 측 통과 비율](attachments/260521_aee977_03.png){fig-align="center"}
...
![④ IMO 별 방문 횟수 + 두 시기 모두 등장한 IMO](attachments/260521_aee977_04.png){fig-align="center"}
...
![⑤ 위: 종료 위치 vs 종료 시각 산점도 (red zone = abrupt end 후보). 아래: 트랙 마지막 점 공간 분포 (빨강 = 후보)](attachments/260521_aee977_05.png){fig-align="center"}
...
![⑥ 4분할: (Before/After) × (Iran/Oman side). 색 = segment 속도 (turbo). 0=빨강·정박, 30+km/h=파랑·정상항해.](attachments/260521_aee977_06.png){fig-align="center"}
